...
from AnanyaxMusic.utils import AdminRightsCheck
from AnanyaxMusic.utils.database import is_active_chat, is_nonadmin_chat
from AnanyaxMusic.utils.decorators.language import languageCB
from AnanyaxMusic.utils.inline import close_markup, speed_markup
...
async def playback(cli, message: Message, _, chat_id):
    ...
    return await message.reply_text(
        text=_["admin_28"].format(akash.mention),
        reply_markup=upl,
    )


@akash.on_callback_query(filters.regex("SpeedUP") & ~BANNED_USERS)
@languageCB
