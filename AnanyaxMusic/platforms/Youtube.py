...
from AnanyaxMusic.utils.database import is_on_off
from AnanyaxMusic import akash
from AnanyaxMusic.utils.formatters import time_to_seconds
import random
import logging
import aiohttp
from AnanyaxMusic import LOGGER
...
async def load_api_url():
    global YOUR_API_URL
    logger = LOGGER("AnanyaxMusic/platforms/Youtube.py")
...
async def get_telegram_file(telegram_link: str, video_id: str, file_type: str) -> str:
    ...
    try:
        ...
        msg = await akash.get_messages(channel_name, message_id)
