<p align="center">
  <img src="https://raw.githubusercontent.com/ZoxxOP/AnanyaxMusic/main/AnanyaxMusic/assets/AnanyaxMusic.png" alt="AnanyaxMusic Bot Logo" width="500px">
</p>

<h1 align="center">🎵 AnanyaxMusic Bot 🎵</h1>
...
<p align="center">
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/fork"><img src="https://img.shields.io/github/forks/ZoxxOP/AnanyaxMusic?style=social" alt="GitHub Forks"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/stargazers"><img src="https://img.shields.io/github/stars/ZoxxOP/AnanyaxMusic?style=social" alt="GitHub Stars"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/graphs/contributors"><img src="https://img.shields.io/github/contributors/ZoxxOP/AnanyaxMusic?style=social" alt="GitHub Contributors"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/issues"><img src="https://img.shields.io/github/issues/ZoxxOP/AnanyaxMusic?style=social" alt="GitHub Issues"></a>
</p>

## 🌟 Quick Deploy

<p align="center">
<a href="https://dashboard.heroku.com/new?template=https://github.com/ZoxxOP/AnanyaxMusic"><img src="https://img.shields.io/badge/Deploy%20To%20Heroku-purple?style=for-the-badge&logo=heroku&logoColor=white" width="200px" alt="Deploy to Heroku"></a>
</p>

<h2 align="center">🚀 Deploy to Render (Free Hosting)</h2>

<p align="center">
  <a href="https://render.com/deploy?repo=https://github.com/ZoxxOP/AnanyaxMusic">
...
<p align="center">
  <a href="https://railway.app/template/AnanyaxMusic?referralCode=ZoxxOP">
...
<p align="center">
  <a href="https://github.com/ZoxxOP/AnanyaxMusic"><img src="https://img.shields.io/github/repo-size/ZoxxOP/AnanyaxMusic?style=flat-square&color=green" alt="Repo Size"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/issues"><img src="https://img.shields.io/github/issues/ZoxxOP/AnanyaxMusic?style=flat-square&color=red" alt="Issues"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/pulls"><img src="https://img.shields.io/github/issues-pr/ZoxxOP/AnanyaxMusic?style=flat-square&color=yellow" alt="Pull Requests"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/network/members"><img src="https://img.shields.io/github/forks/ZoxxOP/AnanyaxMusic?style=flat-square&color=blue" alt="Forks"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/stargazers"><img src="https://img.shields.io/github/stars/ZoxxOP/AnanyaxMusic?style=flat-square&color=orange" alt="Stars"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/blob/main/LICENSE"><img src="https://img.shields.io/github/license/ZoxxOP/AnanyaxMusic?style=flat-square&color=purple" alt="LICENSE"></a>
  <a href="https://github.com/ZoxxOP/AnanyaxMusic/commits/main"><img src="https://img.shields.io/github/last-commit/ZoxxOP/AnanyaxMusic?style=flat-square&color=lightblue" alt="Last Commit"></a>
</p>
...
#### **2. Clone Repository**
```bash
# Clone the AnanyaxMusic repository
git clone https://github.com/ZoxxOP/AnanyaxMusic
cd AnanyaxMusic
...
# Bot Information
BOT_NAME=AnanyaxMusic
BOT_USERNAME=YourBotUsername

# Database (MongoDB Atlas - Free tier available)
MONGO_DB_URI=mongodb+srv://username:password@cluster.mongodb.net/AnanyaxMusic

# Owner Details
OWNER_ID=your_telegram_user_id
OWNER_USERNAME=your_username

# Pyrogram Session String (Generate using @AnanyaSessionBot)
...
# Support Links
SUPPORT_GROUP=https://t.me/AnanyaBotSupport
SUPPORT_CHANNEL=https://t.me/AnanyaBots
...
UPSTREAM_REPO=https://github.com/ZoxxOP/AnanyaxMusic
...
screen -S ananyaxmusic

# Start the bot
python3 -m AnanyaxMusic

# Detach from screen: Press Ctrl+A then D
# To reattach later: screen -r ananyaxmusic
```
...
sudo nano /etc/systemd/system/ananyaxmusic.service
```

Add this content:
```ini
[Unit]
Description=AnanyaxMusic Telegram Bot
After=network.target

[Service]
Type=simple
User=your_username
WorkingDirectory=/path/to/AnanyaxMusic
Environment=PATH=/path/to/AnanyaxMusic/venv/bin
ExecStart=/path/to/AnanyaxMusic/venv/bin/python -m AnanyaxMusic
Restart=always
RestartSec=10
...
sudo systemctl enable ananyaxmusic
sudo systemctl start ananyaxmusic

# Check status
sudo systemctl status ananyaxmusic

# View logs
journalctl -u ananyaxmusic -f
```

## 🔑 Session String Generation

### **Method 1: Telegram Bot (Easiest)**
1. Start [@AnanuaSessionBot](https://t.me/AnanyaSessionBot)
...
# Check logs
tail -f logs/AnanyaxMusic.log

# Restart bot
screen -r ananyaxmusic
# Press Ctrl+C to stop, then restart with python3 -m AnanyaxMusic
```
...
```bash
#!/bin/bash
cd /path/to/AnanyaxMusic
git pull origin main
source venv/bin/activate
pip3 install -r requirements.txt --upgrade
sudo systemctl restart shrutixmusic
echo "AnanyaxMusic updated successfully!"
```
...
AnanyaxMusic supports multiple languages:
- 🇺🇸 **English** (Default)
...
### **Main Developer**
- **ZoxxOP** - Creator and Lead Developer
  - GitHub: [@ZoxxOP](https://github.com/ZoxxOP)
  - Telegram: [@WTF_NoHope](https://t.me/WTF_NoHope)
...
### **Support & Community**
- 📢 **Support Channel**: [@AnanyaBots](https://t.me/AnanyaBots)
- 💬 **Support Group**: [@AnanyaBotSupport](https://t.me/AnanyaBotSupport)
- 🔧 **Session Generator**: [@AnanyaSessionBot](https://t.me/AnanyaSessionBot)

### **Developer Resources**
- 📚 **Documentation**: [Wiki](https://github.com/ZoxxOP/AnanyaxMusic/wiki)
- 🐛 **Issues**: [GitHub Issues](https://github.com/ZoxxOP/AnanyaxMusic/issues)
- 🔄 **Pull Requests**: [GitHub PRs](https://github.com/ZoxxOP/AnanyaxMusic/pulls)
- ⭐ **Discussions**: [GitHub Discussions](https://github.com/ZoxxOP/AnanyaxMusic/discussions)
...
<p align="center">
<b>🎵 Experience Premium Music with AnanyaxMusic Bot! 🎵</b>
</p>
